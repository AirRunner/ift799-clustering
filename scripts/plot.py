...
def plot_max_cluster_size(dates, max_cluster_size, algo, window_size, window_shift, years=None, max_vars=None):
    filter = "full"
    ...
    plt.savefig(f"images/{algo}_max_{window_size}_{window_shift}_{filter}.png")
    plt.show()
...
def plot_k_values(dates, k_values, algo, window_size, window_shift, years=None, max_vars=None):
    ...
    plt.savefig(f"images/{algo}_k_{window_size}_{window_shift}_{filter}.png")
    plt.show()
